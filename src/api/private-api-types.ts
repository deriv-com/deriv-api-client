...
export interface AccountClosureResponse
  extends GenericResponse<"account_closure"> {
  /**
...
export interface AccountSecurityResponse
  extends GenericResponse<"account_security"> {
  /**
...
export interface AccountStatisticsResponse
  extends GenericResponse<"account_statistics"> {
  /**
...
export interface AffiliateAddCompanyResponse
  extends GenericResponse<"affiliate_add_company"> {
  /**
...
export interface AffiliateAddPersonResponse
  extends GenericResponse<"affiliate_add_person"> {
  /**
   * The information of the affiliate user trying to register.
   */
...
export interface AffiliateRegisterPersonResponse
  extends GenericResponse<"affiliate_register_person"> {
  /**
...
export interface AvailableAccountsResponse
  extends GenericResponse<"available_accounts"> {
  available_accounts?: {
    /**
...
export interface CashierPaymentsResponse
  extends GenericResponse<"cashier_payments"> {
  cashier_payments?: {
    /**
...
export interface ChangePasswordResponse
  extends GenericResponse<"change_password"> {
  /**
...
export interface GetAccountTypeResponse
  extends GenericResponse<"get_account_types"> {
  get_account_types?: {
    /**
...
export interface NewAccountWalletResponse
  extends GenericResponse<"new_account_wallet"> {
  new_account_wallet?: {
    /**
...
export interface PasskeysLoginResponse
  extends GenericResponse<"passkeys_login"> {
  /**
...
export interface PasskeysOptionsResponse
  extends GenericResponse<"passkeys_options"> {
  /**
   * Wrapper of the response.
   */
  passkeys_options: {
...
export interface PasskeysRenameResponse
  extends GenericResponse<"passkeys_rename"> {
  /**
   * 1 on success
   */
...
export interface PasskeysRegisterOptionsResponse
  extends GenericResponse<"passkeys_register_options"> {
  /**
   * Wrapper of the response.
   */
...
export interface PasskeysRegisterResponse
  extends GenericResponse<"passkeys_register"> {
  /**
   * Wrapper of the response.
   */
  passkeys_register: {
...
export interface PasskeysRevokeResponse
  extends GenericResponse<"passkeys_revoke"> {
  /**
   * The system id of the stored passkey.
   */
...
export interface ReportRequestResponse
  extends GenericResponse<"request_report"> {
  /**
...
export interface ResetPasswordResponse
  extends GenericResponse<"reset_password"> {
  /**
...
export interface TradingPlatformLeverageResponse
  extends GenericResponse<"trading_platform_leverage"> {
  /**
...
export interface TradingPlatformNewAccountResponse
  extends GenericResponse<"trading_platform_new_account"> {
  /**
...
export interface TradingPlatformPasswordChangeResponse
  extends GenericResponse<"trading_platform_password_change"> {
...
export interface TradingPlatformWithdrawalResponse
  extends GenericResponse<"trading_platform_withdrawal"> {
  /**
...
export interface TradingPlatformProductListingResponse
  extends GenericResponse<"trading_platform_product_listing"> {
  /**
