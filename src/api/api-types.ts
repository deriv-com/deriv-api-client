...
export type TSocketResponse<T extends TSocketEndpointNames> =
  TSocketEndpoints[T]["response"] & TSocketError<T>;
...
export type TSocketSubscribeResponseData<
...
type TSocketRequest<T extends TSocketEndpointNames> =
  TSocketEndpoints[T]["request"];

type TRemovableEndpointName<T extends TSocketEndpointNames> =
...
export type TSocketPaginatateableRequestCleaned<
...
export type TSocketRequestPayload<
  T extends
    | TSocketEndpointNames
    | TSocketPaginateableEndpointNames = TSocketEndpointNames
