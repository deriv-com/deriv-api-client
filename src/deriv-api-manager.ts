...
export class DerivAPIManager {
    ...
    /**
     * Switch to a new connection and swap out the current active connection with it.
     * Brings authorize and subscription context to the new connection.
     * If a connection matching url already exists, reinitialize and swap active connection to that connection.
     * @param endpoint
     * @returns {void}
     */
